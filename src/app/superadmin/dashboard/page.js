    ...
    <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-300 max-w-2xl leading-relaxed">
              সুপার এডমিন প্যানেল থেকে শুধুমাত্র কম্পানি তৈরি, মার্চেন্টদের তথ্য পরিচালনা এবং সাবস্ক্রিপশন ও বিলিং কন্ট্রোল করা যাবে।
            </p>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-purple-600/80">Paying & trial plans</span>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-emerald-600/80">Recurring / Month</span>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-amber-600/80">Next 7 Days</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-xs overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">Live overview of registered businesses</p>
            </div>
            <Link
              href="/superadmin/companies"
                      ...
                      <div className="flex items-center space-x-3.5">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-0.5">
                            ...
                            {comp.phone && <span className="ml-2 font-mono">({comp.phone})</span>}
                          </p>
                        </div>
                      </div>
        ...
        {/* Right 1 Col: SaaS Summary & Quick Links */}
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-xs space-y-4">
            ...
            <div className="space-y-2.5 text-xs">
              <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 flex items-center justify-between">
                ...
                <span className="font-bold text-blue-800 font-mono">৳0</span>
              </div>

              <div className="p-3 bg-emerald-50/60 rounded-xl border border-emerald-100 flex items-center justify-between">
                <div>
                  <p className="font-bold text-emerald-900">Starter Business</p>
                  <p className="text-[11px] text-emerald-600">1 Outlet, 3 Staff, Cash & POS</p>
                </div>
                <span className="font-bold text-emerald-800 font-mono">৳999/mo</span>
              </div>

              <div className="p-3 bg-purple-50/60 rounded-xl border border-purple-100 flex items-center justify-between">
                <div>
                  <p className="font-bold text-purple-900">Standard Pro</p>
                  <p className="text-[11px] text-purple-600">3 Outlets, Transfers, Full Reports</p>
                </div>
                <span className="font-bold text-purple-800 font-mono">৳1,999/mo</span>
              </div>

              <div className="p-3 bg-amber-50/60 rounded-xl border border-amber-100 flex items-center justify-between">
                <div>
                  <p className="font-bold text-amber-900">Enterprise VIP</p>
                  <p className="text-[11px] text-amber-600">10 Outlets, Unlimited Staff, Priority</p>
                </div>
                <span className="font-bold text-amber-800 font-mono">৳3,999/mo</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 text-white rounded-3xl p-6 shadow-xs space-y-3">
            <h4 className="font-bold text-sm flex items-center space-x-2 text-purple-300">
              <ShieldAlert size={16} />
              <span>SaaS Security Architecture</span>
            </h4>
            <p className="text-xs text-slate-400 leading-relaxed">
              সুপার এডমিন হিসেবে আপনি প্রতিটি কম্পানির অ্যাকাউন্ট অ্যাক্টিভেট/সাসপেন্ড করতে পারেন এবং তাদের সাবস্ক্রিপশন মেয়াদ বাড়াতে পারেন। কোনো স্টোর সাবস্ক্রিপশন মেয়াদোত্তীর্ণ হলে ইউজাররা সতর্কবার্তা পাবেন।
            </p>
          </div>
        </div>
      </div>
